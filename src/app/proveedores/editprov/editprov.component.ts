...
export class EditprovComponent implements OnInit {
  ...
  proveedor: any;
  id:string;
  provincias: string[] = ['Álava', 'Albacete', 'Alicante',
  ...
  'Guipúzcoa', 'Huelva', 'Huesca', 'IslasBaleares', 'Jaén', 'León',
  ...
  onSubmit() {
    ...
    this.proveedorService.putProveedor( this.proveedor, this.id ).subscribe(newpre => {
